...
# generated on September 29, 2017 (14:38)
...
AVAILABLE_BS = {
    ...
    'cc-pV5Z(pt/sf/sc)': ESMLBasisSet(
        ...
        ['H', 'He', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar', 'Ga', 'Ge', 'As', 'Se', 'Br', 'Kr']),  # noqa
    'aug-cc-pVDZ-PP Diffuse': ESMLBasisSet(
        'aug-cc-pVDZ-PP Diffuse',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_addElements_3/AUG-CC-PVDZ-PP.xml',
        ['Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Ru', 'Rh', 'Pd']),  # noqa
    'aug-cc-pCV5Z': ESMLBasisSet(
        'aug-cc-pCV5Z',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_correction_1/AUG-CC-PCV5Z.xml',
    ...
    'aug-pc-2': ESMLBasisSet(
        'aug-pc-2',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/frj_addElements_10/AUG-PC-2.xml',
        ['Sc', 'Ti', 'V', 'Cr', 'Mn', 'Fe', 'Co', 'Ni', 'Cu', 'Zn']),  # noqa
    ...
    'aug-cc-pwCVQZ-NR': ESMLBasisSet(
        ...
        ['Sc', 'Ti', 'V', 'Cr', 'Mn', 'Fe', 'Co', 'Ni', 'Cu', 'Zn']),  # noqa
    'cc-pVQZ-NR': ESMLBasisSet(
        'cc-pVQZ-NR',
        '/files/projects/Basis_Set_Curators/Gaussian/emsl-lib/CC-PVQZ-NR.xml',
        ['Sc', 'Ti', 'V', 'Cr', 'Mn', 'Fe', 'Co', 'Ni', 'Cu', 'Zn']),  # noqa
    's6-31G*': ESMLBasisSet(
        's6-31G*',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/marcel.swart_addElements_32/S6-31GS.xml',
        ['Zn']),  # noqa
    'dhf-QZVP': ESMLBasisSet(
        'dhf-QZVP',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/cyborg0001_new_3/DHF-QZVP.xml',
    ...
    '5ZaPa-NR': ESMLBasisSet(
        '5ZaPa-NR',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/comartin_new_3/5ZAPA-NR.xml',
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    ...
    'aug-cc-pVQZ-PP-RI Diffuse': ESMLBasisSet(
        ...
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/haettig_addElements_7/AUG-CC-PVQZ-PP-RIDIFFUSE.xml',
        ['Cu', 'Zn', 'Ag', 'Cd', 'Au', 'Hg']),  # noqa
    'dhf-SVP': ESMLBasisSet(
        'dhf-SVP',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/bert_link_2/DHF-SVP.xml',
        ['Rb', 'Sr', 'Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Ru', 'Rh', 'Pd', 'Ag', 'Cd', 'In', 'Sn', 'Sb', 'Te', 'I', 'Xe', 'Cs', 'Ba', 'Hf', 'Ta', 'W', 'Re', 'Os', 'Ir', 'Pt', 'Au', 'Hg', 'Tl', 'Pb', 'Bi', 'Po', 'At', 'Rn']),  # noqa
    ...
    'cc-pVTZ(fi/sf/sc)': ESMLBasisSet(
        ...
        ['H', 'He', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar', 'Ga', 'Ge', 'As', 'Se', 'Br', 'Kr']),  # noqa
    'aug-cc-pVTZ-PP-new': ESMLBasisSet(
        'aug-cc-pVTZ-PP-new',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_new_4/AUG-CC-PVTZ-PP-NEW.xml',
        ['I']),  # noqa
    ...
    'Bi-ECP60MDF': ESMLBasisSet(
        'Bi-ECP60MDF',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/Zheyan Tu_new_6/BI-ECP60MDF.xml',
        ['Bi']),  # noqa
    'cc-pwCVQZ-RI': ESMLBasisSet(
        'cc-pwCVQZ-RI',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/haettig_new_30/CC-PWCVQZ-RI.xml',
        ['Cu', 'Zn', 'Ag', 'Cd', 'Au', 'Hg']),  # noqa
    'cc-pCV5Z0': ESMLBasisSet(
        'cc-pCV5Z0',
        '/files/projects/Basis_Set_Curators/Gaussian/emsl-lib/CC-PCV5Z0.xml',
        ['Ca']),  # noqa
    'aug-cc-pVTZ-NR Diffuse': ESMLBasisSet(
        'aug-cc-pVTZ-NR Diffuse',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_correction_0/AUG-CC-PVTZ-NRDIFFUSE.xml',
        ['Sc']),  # noqa
    ...
    'pc-0': ESMLBasisSet(
        'pc-0',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/frj_new/PC-0.xml',
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    'cc-pVDZ-F12': ESMLBasisSet(
        'cc-pVDZ-F12',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/GHill_new_10/CC-PVDZ-F12.xml',
        ['Li', 'Be', 'Na', 'Mg']),  # noqa
    ...
    'cc-pwCV5Z-DK': ESMLBasisSet(
        ...
        ['Sc', 'Ti', 'V', 'Cr', 'Mn', 'Fe', 'Co', 'Ni', 'Cu', 'Zn']),  # noqa
    'aug-cc-pVQZ-NR': ESMLBasisSet(
        'aug-cc-pVQZ-NR',
        '/files/projects/Basis_Set_Curators/Gaussian/emsl-lib/AUG-CC-PVQZ-NR-AGG.xml',
        ['Sc', 'Ti', 'V', 'Cr', 'Mn', 'Fe', 'Co', 'Ni', 'Cu', 'Zn']),  # noqa
    ...
    's6-31G': ESMLBasisSet(
        's6-31G',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/marcel.swart_new_20/S6-31G.xml',
        ['Co']),  # noqa
    ...
    'cc-pVDZ-PP-new': ESMLBasisSet(
        'cc-pVDZ-PP-new',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_new/CC-PVDZ-PP-NEW.xml',
        ['I']),  # noqa
    'CRENBS': ESMLBasisSet(
        'CRENBS',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/ermler_new_1/CRENBS.xml',
        ['Uuo']),  # noqa
    ...
    'a': ESMLBasisSet(
        'a',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/sbm2781_new/A.xml',
        ['Li']),  # noqa
    'cc-pVTZ-PP MP2 Fitting': ESMLBasisSet(
        'cc-pVTZ-PP MP2 Fitting',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/GHill_addElements_12/CC-PVTZ-PPMP2FITTING.xml',
        ['Hf', 'Ta', 'W', 'Re', 'Os', 'Ir', 'Pt']),  # noqa
    ...
    'cc-pVQZ-PP': ESMLBasisSet(
        'cc-pVQZ-PP',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_addElements_1/CC-PVQZ-PP.xml',
        ['Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Ru', 'Rh', 'Pd']),  # noqa
    'MINI (Huzinaga)': ESMLBasisSet(
        'MINI (Huzinaga)',
        '/files/projects/Basis_Set_Curators/Gaussian/emsl-lib/MINI.xml',
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar', 'K', 'Ca']),  # noqa
    'aug-cc-pCVDZ-DK': ESMLBasisSet(
        'aug-cc-pCVDZ-DK',
        '/files/projects/Basis_Set_Curators/Gaussian/emsl-lib/AUG-CC-PCVDZ-DK-AGG.xml',
        ['Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    'cc-pwCVDZ-PP MP2 Fitting': ESMLBasisSet(
        'cc-pwCVDZ-PP MP2 Fitting',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/GHill_new_35/CC-PWCVDZ-PPMP2FITTING.xml',
        ['Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Ru', 'Rh', 'Pd']),  # noqa
    ...
    'Sadlej+': ESMLBasisSet(
        ...
        ['H', 'C', 'N', 'O']),  # noqa
    'ECP10MDF': ESMLBasisSet(
        'ECP10MDF',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/wangf44_new_0/ECP10MDF.xml',
        ['Cu']),  # noqa
    ...
    'ANO-VT-DZ': ESMLBasisSet(
        'ANO-VT-DZ',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/danielhmm_new/ANO-VT-DZ.xml',
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    ...
    'cc-pVQZ-F12_OPTRI': ESMLBasisSet(
        ...
        ['H', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    'cc-pVDZ-PP': ESMLBasisSet(
        'cc-pVDZ-PP',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_addElements_18/CC-PVDZ-PP.xml',
        ['Hf', 'Ta', 'W', 'Re', 'Os', 'Ir', 'Pt']),  # noqa
    ...
    'U500': ESMLBasisSet(
        'U500',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/Droog_Andrey_new/U500.xml',
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar', 'K', 'Ca', 'Sc', 'Ti', 'V', 'Cr', 'Mn', 'Fe', 'Co', 'Ni', 'Cu', 'Zn', 'Ga', 'Ge', 'As', 'Se', 'Br', 'Kr', 'Rb', 'Sr', 'Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Ru', 'Rh', 'Pd', 'Ag', 'Cd', 'In', 'Sn', 'Sb', 'Te', 'I', 'Xe', 'Cs', 'Ba', 'La', 'Ce', 'Pr', 'Nd', 'Pm', 'Sm', 'Eu', 'Gd', 'Tb', 'Dy', 'Ho', 'Er', 'Tm', 'Yb', 'Lu', 'Hf', 'Ta', 'W', 'Re', 'Os', 'Ir', 'Pt', 'Au', 'Hg', 'Tl', 'Pb', 'Bi', 'Po', 'At', 'Rn', 'Fr', 'Ra', 'Ac', 'Th', 'Pa', 'U', 'Np', 'Pu', 'Am', 'Cm', 'Bk', 'Cf', 'Es', 'Fm', 'Md', 'No', 'Lr', 'Rf', 'Db', 'Sg', 'Bh', 'Hs', 'Mt', 'Uun', 'Uuu', 'Uub', 'Uut', 'Uuq', 'Uup', 'Uuh', 'Uus', 'Uuo']),  # noqa
    ...
    'B2 basis set for Zn': ESMLBasisSet(
        ...
        ['Zn']),  # noqa
    'kr-augccpvqz': ESMLBasisSet(
        'kr-augccpvqz',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/Zheyan Tu_new_4/KR-AUGCCPVQZ.xml',
        ['Kr']),  # noqa
    ...
    'cc-pVTZ(pt/sf/lc)': ESMLBasisSet(
        ...
        ['H', 'He', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar', 'Ga', 'Ge', 'As', 'Se', 'Br', 'Kr']),  # noqa
    'cc-pwCVDZ-PP': ESMLBasisSet(
        'cc-pwCVDZ-PP',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_addElements_7/CC-PWCVDZ-PP.xml',
        ['Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Ru', 'Rh', 'Pd']),  # noqa
    'apr-cc-pV(Q+d)Z': ESMLBasisSet(
        'apr-cc-pV(Q+d)Z',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/Papajak_new_21/APR-CC-PVQPDZ.xml',
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    ...
    'aug-cc-pVQZ-PP MP2 Fitting': ESMLBasisSet(
        ...
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/GHill_addElements_5/AUG-CC-PVQZ-PPMP2FITTING.xml',
        ['Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Rh', 'Pd']),  # noqa
    'aug-cc-pVTZ-PP MP2 Fitting': ESMLBasisSet(
        'aug-cc-pVTZ-PP MP2 Fitting',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/GHill_addElements_16/AUG-CC-PVTZ-PPMP2FITTING.xml',
        ['Hf', 'Ta', 'W', 'Re', 'Os', 'Ir', 'Pt']),  # noqa
    ...
    'jun-cc-pV(D+d)Z': ESMLBasisSet(
        'jun-cc-pV(D+d)Z',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/papajak_new_23/JUN-CC-PVDPDZ.xml',
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    ...
    'dhf-QZVPP': ESMLBasisSet(
        'dhf-QZVPP',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/bert_link_0/DHF-QZVPP.xml',
        ['Rb', 'Sr', 'Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Ru', 'Rh', 'Pd', 'Ag', 'Cd', 'In', 'Sn', 'Sb', 'Te', 'I', 'Xe', 'Cs', 'Ba', 'Hf', 'Ta', 'W', 'Re', 'Os', 'Ir', 'Pt', 'Au', 'Hg', 'Tl', 'Pb', 'Bi', 'Po', 'At', 'Rn']),  # noqa
    ...
    'aug-cc-pVDZ-PP-RI Diffuse': ESMLBasisSet(
        ...
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/haettig_addElements_5/AUG-CC-PVDZ-PP-RIDIFFUSE.xml',
        ['Cu', 'Zn', 'Ag', 'Cd', 'Au', 'Hg']),  # noqa
    'aug-pc-0': ESMLBasisSet(
        'aug-pc-0',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/frj_addElements_4/AUG-PC-0.xml',
        ['K', 'Ca', 'Ga', 'Ge', 'As', 'Se', 'Br', 'Kr']),  # noqa
    'cc-pwCV5Z-PP MP2 Fitting': ESMLBasisSet(
        'cc-pwCV5Z-PP MP2 Fitting',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/GHill_new_38/CC-PWCV5Z-PPMP2FITTING.xml',
        ['Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Ru', 'Rh', 'Pd']),  # noqa
    ...
    'STO-3G*': ESMLBasisSet(
        ...
        ['Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    'cc-pwCVQZ-PP': ESMLBasisSet(
        'cc-pwCVQZ-PP',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_addElements_9/CC-PWCVQZ-PP.xml',
        ['Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Ru', 'Rh', 'Pd']),  # noqa
    'cc-pV5Z(fi/sf/lc)': ESMLBasisSet(
        'cc-pV5Z(fi/sf/lc)',
        '/files/projects/Basis_Set_Curators/Gaussian/emsl-lib/CC-PV5Z_FI_SF_LC.xml',
        ['H', 'He', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar', 'Ga', 'Ge', 'As', 'Se', 'Br', 'Kr']),  # noqa
    'Hg-ECP60MDF': ESMLBasisSet(
        'Hg-ECP60MDF',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/Zheyan Tu_new_1/HG-ECP60MDF.xml',
        ['Hg']),  # noqa
    ...
    '6-31G*': ESMLBasisSet(
        '6-31G*',
        '/files/projects/Basis_Set_Curators/Gaussian/emsl-lib/6-31GS-AGG.xml',
        ['Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar', 'K', 'Ca', 'Sc', 'Ti', 'V', 'Cr', 'Mn', 'Fe', 'Co', 'Ni', 'Cu', 'Zn']),  # noqa
    'aug-cc-pVTZ-J': ESMLBasisSet(
        'aug-cc-pVTZ-J',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/steinmann_addElements/AUG-CC-PVTZ-J.xml',
        ['Ga', 'Ge', 'As', 'Se', 'Br']),  # noqa
    ...
    'may-cc-pV(T+d)Z': ESMLBasisSet(
        'may-cc-pV(T+d)Z',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/papajak_new_19/MAY-CC-PVTPDZ.xml',
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    'O-ANOL': ESMLBasisSet(
        'O-ANOL',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/ganymede_new_0/O-ANOL.xml',
        ['O']),  # noqa
    ...
    'aug-cc-pVDZ-PP MP2 Fitting': ESMLBasisSet(
        ...
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/GHill_addElements_1/AUG-CC-PVDZ-PPMP2FITTING.xml',
        ['Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Rh', 'Pd']),  # noqa
    ...
    'aug-mcc-pVTZ': ESMLBasisSet(
        ...
        ['H']),  # noqa
    'cc-pwCV5Z-PP': ESMLBasisSet(
        'cc-pwCV5Z-PP',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_addElements_29/CC-PWCV5Z-PP.xml',
        ['Hf', 'Ta', 'W', 'Re', 'Os', 'Ir', 'Pt']),  # noqa
    '6-31G': ESMLBasisSet(
        '6-31G',
    ...
    'CRENBL': ESMLBasisSet(
        'CRENBL',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/ermler_new_0/CRENBL.xml',
        ['Uuo']),  # noqa
    ...
    'cc-pCV6Z (old)': ESMLBasisSet(
        ...
        ['B', 'C', 'N', 'O', 'F', 'Ne', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    'aug-cc-pVDZ-PP': ESMLBasisSet(
        'aug-cc-pVDZ-PP',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_addElements_22/AUG-CC-PVDZ-PP.xml',
        ['Hf', 'Ta', 'W', 'Re', 'Os', 'Ir', 'Pt']),  # noqa
    ...
    'pcJ-4_2006': ESMLBasisSet(
        ...
        ['H', 'He', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    'aug-cc-pVQZ-PP Diffuse': ESMLBasisSet(
        'aug-cc-pVQZ-PP Diffuse',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_addElements_5/AUG-CC-PVQZ-PP.xml',
        ['Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Ru', 'Rh', 'Pd']),  # noqa
    ...
    'pcS-2': ESMLBasisSet(
        ...
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    'aug-cc-pV5Z-PP': ESMLBasisSet(
        'aug-cc-pV5Z-PP',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_addElements_25/AUG-CC-PV5Z-PP.xml',
        ['Hf', 'Ta', 'W', 'Re', 'Os', 'Ir', 'Pt']),  # noqa
    ...
    'coemd-2': ESMLBasisSet(
        ...
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    'Au-ECP60MDF': ESMLBasisSet(
        'Au-ECP60MDF',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/Zheyan Tu_new_3/AU-ECP60MDF.xml',
        ['Au']),  # noqa
    '5ZP': ESMLBasisSet(
        '5ZP',
    ...
    '6ZaPa-NR': ESMLBasisSet(
        ...
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    'aug-cc-pVQZ-PP-new': ESMLBasisSet(
        'aug-cc-pVQZ-PP-new',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_new_5/AUG-CC-PVQZ-PP-NEW.xml',
        ['I']),  # noqa
    '3-21G*': ESMLBasisSet(
        '3-21G*',
    ...
    'aug-pcS-3': ESMLBasisSet(
        ...
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    'cc-pVTZ-NR': ESMLBasisSet(
        'cc-pVTZ-NR',
        '/files/projects/Basis_Set_Curators/Gaussian/emsl-lib/CC-PVTZ-NR.xml',
        ['Sc', 'Ti', 'V', 'Cr', 'Mn', 'Fe', 'Co', 'Ni', 'Cu', 'Zn']),  # noqa
    'jul-cc-pV(Q+d)Z': ESMLBasisSet(
        'jul-cc-pV(Q+d)Z',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/papajak_new_10/JUL-CC-PVQPDZ.xml',
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    'cc-pV5Z': ESMLBasisSet(
        'cc-pV5Z',
        '/files/projects/Basis_Set_Curators/Gaussian/emsl-lib/CC-PV5Z.xml',
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar', 'Ca', 'Sc', 'Ti', 'V', 'Cr', 'Mn', 'Fe', 'Co', 'Ni', 'Cu', 'Zn', 'Ga', 'Ge', 'As', 'Se', 'Br', 'Kr']),  # noqa
    'aug-cc-pVTZ-PP Diffuse': ESMLBasisSet(
        'aug-cc-pVTZ-PP Diffuse',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_addElements_4/AUG-CC-PVTZ-PP.xml',
        ['Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Ru', 'Rh', 'Pd']),  # noqa
    '6-31G-Blaudeau': ESMLBasisSet(
        '6-31G-Blaudeau',
    ...
    'MINIs-BSIP1': ESMLBasisSet(
        'MINIs-BSIP1',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/aoterodelaroza_new/MINIS-BSIP1.xml',
    ...
    'pcJ-4': ESMLBasisSet(
        ...
        ['H', 'He', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    'aug-cc-pV5Z-PP Diffuse': ESMLBasisSet(
        'aug-cc-pV5Z-PP Diffuse',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_addElements_6/AUG-CC-PV5Z-PP.xml',
        ['Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Ru', 'Rh', 'Pd']),  # noqa
    ...
    'maug-cc-pVTZ': ESMLBasisSet(
        'maug-cc-pVTZ',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/Papajak_new_4/MAUG-CC-PVTZ.xml',
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    'cc-pV5Z-PP MP2 Fitting': ESMLBasisSet(
        'cc-pV5Z-PP MP2 Fitting',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/GHill_addElements_4/CC-PV5Z-PPMP2FITTING.xml',
        ['Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Rh', 'Pd']),  # noqa
    'CVTZ': ESMLBasisSet(
        'CVTZ',
    ...
    'cc-pV(D+d)Z-RI': ESMLBasisSet(
        ...
        ['Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    'Cd-ECP28MDF': ESMLBasisSet(
        'Cd-ECP28MDF',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/Zheyan Tu_new_0/CD-ECP28MDF.xml',
        ['Cd']),  # noqa
    ...
    'dhf-TZVPP': ESMLBasisSet(
        'dhf-TZVPP',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/bert_link_4/DHF-TZVPP.xml',
        ['Rb', 'Sr', 'Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Ru', 'Rh', 'Pd', 'Ag', 'Cd', 'In', 'Sn', 'Sb', 'Te', 'I', 'Xe', 'Cs', 'Ba', 'Hf', 'Ta', 'W', 'Re', 'Os', 'Ir', 'Pt', 'Au', 'Hg', 'Tl', 'Pb', 'Bi', 'Po', 'At', 'Rn']),  # noqa
    'dhf-SV(P)': ESMLBasisSet(
        'dhf-SV(P)',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/cyborg0001_new/DHF-SVP.xml',
        ['Rb', 'Sr', 'Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Ru', 'Rh', 'Pd', 'Ag', 'Cd', 'In', 'Sn', 'Sb', 'Te', 'I', 'Xe', 'Cs', 'Ba', 'Hf', 'Ta', 'W', 'Re', 'Os', 'Ir', 'Pt', 'Au', 'Hg', 'Tl', 'Pb', 'Bi', 'Po', 'At', 'Rn']),  # noqa
    ...
    'Bauschlicher ANO': ESMLBasisSet(
        ...
        ['Sc', 'Ti', 'V', 'Cr', 'Mn', 'Fe', 'Co', 'Ni', 'Cu']),  # noqa
    'aug-cc-pVTZ-NR MP2 Fitting': ESMLBasisSet(
        'aug-cc-pVTZ-NR MP2 Fitting',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/GHill_new_0/AUG-CC-PVTZ-NRMP2FITTING.xml',
        ['Sc', 'Ti', 'V', 'Cr', 'Mn', 'Fe', 'Co', 'Ni', 'Cu']),  # noqa
    ...
    'aug-cc-pwCVTZ-DK': ESMLBasisSet(
        'aug-cc-pwCVTZ-DK',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_addElements_14/AUG-CC-PWCVTZ-DK.xml',
        ['Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Ru', 'Rh', 'Pd']),  # noqa
    ...
    'cc-pVQZ': ESMLBasisSet(
        ...
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar', 'Ca', 'Sc', 'Ti', 'V', 'Cr', 'Mn', 'Fe', 'Co', 'Ni', 'Cu', 'Zn', 'Ga', 'Ge', 'As', 'Se', 'Br', 'Kr']),  # noqa
    'aug-cc-pCVQZ-DK': ESMLBasisSet(
        'aug-cc-pCVQZ-DK',
        '/files/projects/Basis_Set_Curators/Gaussian/emsl-lib/AUG-CC-PCVQZ-DK-AGG.xml',
        ['Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    ...
    'pc-3': ESMLBasisSet(
        'pc-3',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/frj_new_2/PC-3.xml',
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    ...
    'SARC-ZORA': ESMLBasisSet(
        'SARC-ZORA',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/demchem_addElements_1/SARC-ZORA.xml',
        ['Tl', 'Pb', 'Bi', 'Po', 'At', 'Rn']),  # noqa
    'cc-pVDZ-PP MP2 Fitting': ESMLBasisSet(
        'cc-pVDZ-PP MP2 Fitting',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/GHill_addElements_9/CC-PVDZ-PPMP2FITTING.xml',
        ['Hf', 'Ta', 'W', 'Re', 'Os', 'Ir', 'Pt']),  # noqa
    'jareds cc-pVDZ': ESMLBasisSet(
        'jareds cc-pVDZ',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/jm_chase_new/JAREDSCC-PVDZ.xml',
        ['C']),  # noqa
    ...
    'cc-pVQZ(fi/sf/fw)': ESMLBasisSet(
        ...
        ['H', 'He', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar', 'Ga', 'Ge', 'As', 'Se', 'Br', 'Kr']),  # noqa
    'Modified Wachters-Hay basis for Zn': ESMLBasisSet(
        'Modified Wachters-Hay basis for Zn',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/eamin_new/MODIFIEDWACHTERS-HAYBASISFORZN1.xml',
        ['Zn']),  # noqa
    ...
    'aug-cc-pwCV5Z-DK': ESMLBasisSet(
        'aug-cc-pwCV5Z-DK',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_correction_5/AUG-CC-PWCV5Z-DK.xml',
        ['Fe']),  # noqa
    'pc-2': ESMLBasisSet(
        'pc-2',
    ...
    'aug-pcJ-3': ESMLBasisSet(
        ...
        ['H', 'He', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    'cc-pVTZ-PP-new': ESMLBasisSet(
        'cc-pVTZ-PP-new',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_new_0/CC-PVTZ-PP-NEW.xml',
        ['I']),  # noqa
    'Tl-ECP60MDF': ESMLBasisSet(
        'Tl-ECP60MDF',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/Zheyan Tu_new_5/TL-ECP60MDF.xml',
        ['Tl']),  # noqa
    ...
    's3-21G': ESMLBasisSet(
        's3-21G',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/marcel.swart_new_18/S3-21G.xml',
        ['Cr']),  # noqa
    ...
    'DZP (Dunning)': ESMLBasisSet(
        ...
        ['H', 'Li', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Al', 'Si', 'P', 'S', 'Cl']),  # noqa
    'ANO-VT-QZ': ESMLBasisSet(
        'ANO-VT-QZ',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/danielhmm_new_1/ANO-VT-QZ.xml',
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    'pcS-4': ESMLBasisSet(
        'pcS-4',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/frj_new_28/PCS-4.xml',
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    'aug-cc-pVDZ-PP-new': ESMLBasisSet(
        'aug-cc-pVDZ-PP-new',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_new_3/AUG-CC-PVDZ-PP-NEW.xml',
        ['I']),  # noqa
    'aug-pc-4': ESMLBasisSet(
        'aug-pc-4',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/frj_addElements_8/AUG-PC-4.xml',
        ['K', 'Ca', 'Ga', 'Ge', 'As', 'Se', 'Br', 'Kr']),  # noqa
    ...
    'd-aug-cc-pVDZ': ESMLBasisSet(
        ...
        ['H', 'He', 'B', 'C', 'N', 'O', 'F', 'Ne']),  # noqa
    'cc-pV5Z-PP-new': ESMLBasisSet(
        'cc-pV5Z-PP-new',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_new_2/CC-PV5Z-PP-NEW.xml',
        ['I']),  # noqa
    ...
    'cc-pVTZ-F12': ESMLBasisSet(
        'cc-pVTZ-F12',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/GHill_new_11/CC-PVTZ-F12.xml',
        ['Li', 'Be', 'Na', 'Mg']),  # noqa
    ...
    'pcSseg-3': ESMLBasisSet(
        ...
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar', 'K', 'Ca', 'Sc', 'Ti', 'V', 'Cr', 'Mn', 'Fe', 'Co', 'Ni', 'Cu', 'Zn', 'Ga', 'Ge', 'As', 'Se', 'Br', 'Kr']),  # noqa
    'Ag-ECP28MDF': ESMLBasisSet(
        'Ag-ECP28MDF',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/Zheyan Tu_new_2/AG-ECP28MDF.xml',
        ['Ag']),  # noqa
    ...
    'pc-4': ESMLBasisSet(
        'pc-4',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/frj_new_3/PC-4.xml',
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    ...
    '6-31+G*': ESMLBasisSet(
        '6-31+G*',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/drhaney_correction/6-31PGS.xml',
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar', 'K', 'Ca', 'Sc', 'Ti', 'V', 'Cr', 'Mn', 'Fe', 'Co', 'Ni', 'Cu', 'Zn', 'Ga', 'Ge', 'As', 'Se', 'Br', 'Kr']),  # noqa
    'MIDI!': ESMLBasisSet(
        'MIDI!',
    ...
    'm6-31G*': ESMLBasisSet(
        'm6-31G*',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/marcel.swart_new_8/M6-31GS.xml',
        ['Co']),  # noqa
    'pcJ-1': ESMLBasisSet(
        'pcJ-1',
    ...
    'cc-pV6Z-RI': ESMLBasisSet(
        'cc-pV6Z-RI',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/haettig_new_11/CC-PV6Z-RI.xml',
        ['H', 'He', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    ...
    'cc-pwCVTZ': ESMLBasisSet(
        ...
        ['B', 'C', 'N', 'O', 'F', 'Ne', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    'cc-pCV6Z (2nd row)': ESMLBasisSet(
        'cc-pCV6Z (2nd row)',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_new_15/CC-PCV6Z.xml',
        ['Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    'x2c-SV(P)all-2c': ESMLBasisSet(
        ...
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar', 'K', 'Ca', 'Sc', 'Ti', 'V', 'Cr', 'Mn', 'Fe', 'Co', 'Ni', 'Cu', 'Zn', 'Ga', 'Ge', 'As', 'Se', 'Br', 'Kr', 'Rb', 'Sr', 'Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Ru', 'Rh', 'Pd', 'Ag', 'Cd', 'In', 'Sn', 'Sb', 'Te', 'I', 'Xe', 'Cs', 'Ba', 'La', 'Ce', 'Pr', 'Nd', 'Pm', 'Sm', 'Eu', 'Gd', 'Tb', 'Dy', 'Ho', 'Er', 'Tm', 'Yb', 'Lu', 'Hf', 'Ta', 'W', 'Re', 'Os', 'Ir', 'Pt', 'Au', 'Hg', 'Tl', 'Pb', 'Bi', 'Po', 'At', 'Rn']),  # noqa
    'cc-pwCVTZ-PP': ESMLBasisSet(
        'cc-pwCVTZ-PP',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_new_27/CC-PWCVTZ-PP.xml',
        ['Ga', 'Ge', 'As', 'Se', 'Br', 'Kr', 'In', 'Sn', 'Sb', 'Te', 'I', 'Xe', 'Tl', 'Pb', 'Bi', 'Po', 'At', 'Rn']),  # noqa
    ...
    'jul-cc-pV(T+d)Z': ESMLBasisSet(
        'jul-cc-pV(T+d)Z',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/papajak_new_1/JUL-CC-PVTPDZ.xml',
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    ...
    'cc-pwCVTZ-DK': ESMLBasisSet(
        'cc-pwCVTZ-DK',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_addElements_13/CC-PWCVTZ-DK.xml',
        ['Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Ru', 'Rh', 'Pd']),  # noqa
    ...
    'aug-cc-pV5Z-PP-RI Diffuse': ESMLBasisSet(
        ...
        ['Cu', 'Zn', 'Ga', 'Ge', 'As', 'Se', 'Br', 'Kr', 'Ag', 'Cd', 'In', 'Sn', 'Sb', 'Te', 'I', 'Xe', 'Au', 'Hg', 'Tl', 'Pb', 'Bi', 'Po', 'At', 'Rn']),  # noqa
    'Kaufmann Rydberg': ESMLBasisSet(
        'Kaufmann Rydberg',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/tentsche_new/KAUFMANNRYDBERG.xml',
        ['X']),  # noqa
    ...
    'maug-cc-pV(Q+d)Z': ESMLBasisSet(
        ...
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    'cc-pV5Z-NR': ESMLBasisSet(
        'cc-pV5Z-NR',
        '/files/projects/Basis_Set_Curators/Gaussian/emsl-lib/CC-PV5Z-NR.xml',
        ['Sc', 'Ti', 'V', 'Cr', 'Mn', 'Fe', 'Co', 'Ni', 'Cu', 'Zn']),  # noqa
    'aug-cc-pVDZ_OPTRI': ESMLBasisSet(
        'aug-cc-pVDZ_OPTRI',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_new_19/AUG-CC-PVDZ_OPTRI.xml',
        ['H', 'He', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    'aug-cc-pVQZ-PP': ESMLBasisSet(
        'aug-cc-pVQZ-PP',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_addElements_24/AUG-CC-PVQZ-PP.xml',
        ['Hf', 'Ta', 'W', 'Re', 'Os', 'Ir', 'Pt']),  # noqa
    ...
    'Chipman DZP + Diffuse': ESMLBasisSet(
        ...
        ['H', 'B', 'C', 'N', 'O', 'F']),  # noqa
    'aug-cc-pVTZ-PP': ESMLBasisSet(
        'aug-cc-pVTZ-PP',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_addElements_23/AUG-CC-PVTZ-PP.xml',
        ['Hf', 'Ta', 'W', 'Re', 'Os', 'Ir', 'Pt']),  # noqa
    ...
    'cc-pV5Z-RI': ESMLBasisSet(
        ...
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    'Zn-ECP10MDF-ECP10MDF': ESMLBasisSet(
        'Zn-ECP10MDF-ECP10MDF',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/Zheyan Tu_new/ZN-ECP10MDF-ECP10MDF.xml',
        ['Zn']),  # noqa
    ...
    'aug-cc-pCVTZ-DK': ESMLBasisSet(
        'aug-cc-pCVTZ-DK',
        '/files/projects/Basis_Set_Curators/Gaussian/emsl-lib/AUG-CC-PCVTZ-DK-AGG.xml',
        ['Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    'cc-pVTZ+': ESMLBasisSet(
        'cc-pVTZ+',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/Papajak_new/CC-PVTZP.xml',
        ['H', 'C', 'N', 'O', 'S', 'Cl']),  # noqa
    'cc-pVTZ-PP': ESMLBasisSet(
        'cc-pVTZ-PP',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_addElements_19/CC-PVTZ-PP.xml',
        ['Hf', 'Ta', 'W', 'Re', 'Os', 'Ir', 'Pt']),  # noqa
    ...
    'Binning/Curtiss SVP': ESMLBasisSet(
        ...
        ['Ga', 'Ge', 'As', 'Se', 'Br', 'Kr']),  # noqa
    'cc-pVQZ-PP-new': ESMLBasisSet(
        'cc-pVQZ-PP-new',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_new_1/CC-PVQZ-PP-NEW.xml',
        ['I']),  # noqa
    'pc-1': ESMLBasisSet(
        'pc-1',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/frj_addElements_13/PC-1.xml',
        ['Sc', 'Ti', 'V', 'Cr', 'Mn', 'Fe', 'Co', 'Ni', 'Cu', 'Zn']),  # noqa
    ...
    'cc-pCVQZ-F12': ESMLBasisSet(
        'cc-pCVQZ-F12',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_new_13/CC-PCVQZ-F12.xml',
        ['B', 'C', 'N', 'O', 'F', 'Ne', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    ...
    'cc-pCVDZ-F12': ESMLBasisSet(
        'cc-pCVDZ-F12',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/GHill_new_13/CC-PCVDZ-F12.xml',
        ['Li', 'Be', 'Na', 'Mg']),  # noqa
    ...
    'cc-pwCVDZ': ESMLBasisSet(
        ...
        ['B', 'C', 'N', 'O', 'F', 'Ne', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    'cc-pV5Z-PP': ESMLBasisSet(
        'cc-pV5Z-PP',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_addElements_21/CC-PV5Z-PP.xml',
        ['Hf', 'Ta', 'W', 'Re', 'Os', 'Ir', 'Pt']),  # noqa
    ...
    'aug-cc-pwCVTZ-PP MP2 Fitting': ESMLBasisSet(
        ...
        ['Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Ru', 'Rh', 'Pd']),  # noqa
    'ANO-VT-TZ': ESMLBasisSet(
        'ANO-VT-TZ',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/danielhmm_new_0/ANO-VT-TZ.xml',
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar']),  # noqa
    ...
    'ATZP': ESMLBasisSet(
        ...
        ['H', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar', 'K', 'Sc', 'Ti', 'V', 'Cr', 'Mn', 'Fe', 'Co', 'Ni', 'Cu', 'Zn', 'Ga', 'Ge', 'As', 'Se', 'Br', 'Kr', 'Rb', 'Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Ru', 'Rh', 'Pd', 'Ag', 'Cd', 'In', 'Sn', 'Sb', 'Te', 'I', 'Xe']),  # noqa
    'aug-cc-pVTZ-NR': ESMLBasisSet(
        'aug-cc-pVTZ-NR',
        '/files/projects/Basis_Set_Curators/Gaussian/emsl-lib/AUG-CC-PVTZ-NR-AGG.xml',
        ['Sc', 'Ti', 'V', 'Cr', 'Mn', 'Fe', 'Co', 'Ni', 'Cu', 'Zn']),  # noqa
    'ECP60MDF': ESMLBasisSet(
        'ECP60MDF',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/wangf44_new/ECP60MDF.xml',
        ['Hg']),  # noqa
    ...
    'aug-cc-pV5Z-PP MP2 Fitting': ESMLBasisSet(
        ...
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/GHill_addElements_18/AUG-CC-PV5Z-PPMP2FITTING.xml',
        ['Hf', 'Ta', 'W', 'Re', 'Os', 'Ir', 'Pt']),  # noqa
    'cc-pwCVTZ-PP MP2 Fitting': ESMLBasisSet(
        'cc-pwCVTZ-PP MP2 Fitting',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/GHill_new_36/CC-PWCVTZ-PPMP2FITTING.xml',
        ['Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Ru', 'Rh', 'Pd']),  # noqa
    'pV6Z': ESMLBasisSet(
        'pV6Z',
    ...
    'cc-pVTZ-PP-RI': ESMLBasisSet(
        'cc-pVTZ-PP-RI',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/haettig_addElements_0/CC-PVTZ-PP-RI.xml',
        ['Ga', 'Ge', 'As', 'Se', 'Br', 'Kr', 'In', 'Sn', 'Sb', 'Te', 'I', 'Xe', 'Tl', 'Pb', 'Bi', 'Po', 'At', 'Rn']),  # noqa
    ...
    'cc-pVTZ-RI': ESMLBasisSet(
        ...
        ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar', 'Ga', 'Ge', 'As', 'Se', 'Br', 'Kr']),  # noqa
    'aug-cc-pV5Z-PP-new': ESMLBasisSet(
        'aug-cc-pV5Z-PP-new',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_new_6/AUG-CC-PV5Z-PP-NEW.xml',
        ['I']),  # noqa
    ...
    'Lanl2-[6s4p4d2f]': ESMLBasisSet(
        ...
        ['Rh']),  # noqa
    'aug-cc-pV5Z-NR': ESMLBasisSet(
        'aug-cc-pV5Z-NR',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_correction_3/AUG-CC-PV5Z-NR.xml',
        ['Sc']),  # noqa
    ...
    's3-21G*': ESMLBasisSet(
        's3-21G*',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/marcel.swart_new_19/S3-21GS.xml',
        ['Co']),  # noqa
    'cc-pV5Z-PP-RI': ESMLBasisSet(
        'cc-pV5Z-PP-RI',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/haettig_addElements_4/CC-PV5Z-PP-RI.xml',
        ['Cu', 'Zn', 'Ag', 'Cd', 'Au', 'Hg']),  # noqa
    ...
    'cc-pVTZ-DK': ESMLBasisSet(
        'cc-pVTZ-DK',
        '/files/projects/Basis_Set_Curators/Gaussian/contrib/kipeters_addElements_11/CC-PVTZ-DK.xml',
        ['Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Ru', 'Rh', 'Pd']),  # noqa
